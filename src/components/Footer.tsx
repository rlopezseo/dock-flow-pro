        ...
        <div className="pt-24 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-[13px] text-[hsl(220,15%,45%)] font-body font-normal leading-[2] tracking-[0.02em] max-w-lg">
              TrucksOnTheMap is an all-in-one logistics platform that helps shippers, carriers, and warehouses coordinate dock scheduling, gain real-time freight visibility, and optimise time slot management across Europe. From inbound coordination to last-mile tracking, our software brings transparency to every mile.
            </p>
          </div>
