    ...
    <section id="contact" className="py-28 relative" ref={ref}>
      <div className="container relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display font-light tracking-tight text-foreground mb-5">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-primary-foreground font-body font-normal text-sm rounded-full hover:bg-primary/90 transition-all duration-300 hover:shadow-lg"
            >
              Get in Contact <ArrowUpRight className="w-4 h-4" />
            </a>
            <a
              href="tel:+442038078493"
              className="inline-flex items-center gap-2 px-8 py-3.5 border border-border text-foreground font-body font-normal text-sm rounded-full hover:bg-secondary transition-colors"
            >
              +44 (20) 3807 84 93
            </a>
          </div>
