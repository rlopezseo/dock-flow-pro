...
const LogoCarouselSection = () => {
  ...
  return (
    <section className="relative bg-[hsl(207,60%,30%)] py-14 overflow-hidden">
      <p className="text-center text-xs font-body font-normal tracking-[0.25em] uppercase text-white/50 mb-10">
        Trusted by Industry Leaders
      </p>

      {/* Fade edges */}
      <div className="absolute left-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-r from-[hsl(207,60%,30%)] to-transparent pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-32 z-10 bg-gradient-to-l from-[hsl(207,60%,30%)] to-transparent pointer-events-none" />
