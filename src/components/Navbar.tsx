...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      {/* Top bar */}
      <div className="bg-[hsl(210,15%,13%/0.85)] backdrop-blur-md border-b border-white/10">
      ...
      {/* Main nav */}
      <nav className="bg-[hsl(210,15%,13%/0.85)] backdrop-blur-md border-b border-white/15">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="md:hidden bg-[hsl(210,15%,13%)] border-b border-white/15"
          >
