...
const config: ProductPageConfig = {
  ...
  hero: {
    ...
    subtext: "Live visibility across every shipment, every carrier, every mode. Proactive alerts, accurate ETAs, and exception management that keeps your supply chain moving.",
  ...
  outcomes: {
    ...
    cards: [
      { icon: Bell, target: 45, suffix: "%", sublabel: "fewer calls", title: "Proactive exception alerts", description: "Delays are detected before they happen and alerts are triggered to your team and customers automatically." },
  ...
  useCases: {
    ...
    cases: [
      ...
      { id: "3pl", icon: Package, label: "3PL Providers", image: img3pl, headline: "Client-facing visibility for logistics service providers", description: "Give your clients live tracking with branded portals while keeping operational control. Stand out with better visibility.", benefits: ["White-label tracking portals", "Client-specific dashboards", "SLA monitoring and reporting", "Multi-client shipment management"] },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { icon: Satellite, step: "02", title: "Track Automatically", description: "Every shipment is tracked from pickup to delivery. GPS pings every 15 minutes, configurable to your needs." },
      { icon: Bell, step: "03", title: "Receive Proactive Alerts", description: "The system monitors every shipment for late departures, route deviations, and ETA changes, and alerts your team before issues escalate." },
  ...
  compare: {
    ...
    cta: "Switch to Live Visibility",
  },
  faq: {
    label: "Frequently Asked Questions",
    headline: "Freight visibility platform FAQ: integrations, accuracy, and setup",
    items: [
      { q: "What is a real-time freight visibility platform?", a: "It's a platform that provides live GPS tracking of shipments across your entire supply chain, regardless of carrier, mode, or region. It replaces manual 'where is my truck?' calls with automated tracking, proactive alerts, and predictive ETAs." },
      { q: "How many carriers can a freight visibility platform track?", a: "TrucksOnTheMap has 200+ pre-built carrier integrations and supports GPS, telematics, ELD, and mobile app tracking. Any carrier with a GPS device or smartphone can be tracked." },
      { q: "How accurate are the ETAs?", a: "The machine-learning ETA engine achieves 92% accuracy by analyzing live traffic, weather, driver behavior, hours-of-service regulations, and historical patterns for each lane. Far more accurate than basic GPS distance calculations." },
      { q: "Can the platform share tracking with our customers?", a: "Yes. You can set up branded tracking portals where your clients see live shipment status, ETAs, and milestones. Automated notifications by email and SMS keep them informed without manual work." },
      { q: "Does it support temperature monitoring?", a: "Yes. The platform integrates with IoT temperature and humidity sensors for cold chain freight. You get alerts for temperature excursions, door-open events, and compliance documentation." },
      ...
      { q: "What happens when a delay is detected?", a: "The system triggers an alert via your configured channels (email, SMS, webhook). The dashboard shows the exception with root cause, estimated impact, and recommended actions so you can act before customers notice." },
      { q: "Can it track multi-modal and international shipments?", a: "Yes. Road, rail, ocean, and air freight tracking are supported. Multi-leg and cross-border shipments show up in a single view with customs milestones and carrier handoff visibility." },
      ...
      { q: "How is this different from TMS tracking?", a: "TMS tracking is usually limited to your own system's carriers and relies on EDI updates. A visibility platform aggregates live GPS data from any carrier, adds predictive intelligence, and provides proactive alerts across all carriers." },
    ],
  },
  ctaFinal: {
    label: "Ready to See Everything?",
    headline: "Let's talk freight visibility",
    subtext: "Book a 30-minute demo. We'll show you how to track every shipment live, cut exception response time, and improve on-time delivery.",
  },
};
