...
const config: ProductPageConfig = {
  ...
  hero: {
    ...
    subtext: "TrucksOnTheMap delivers machine learning ETAs that account for traffic, weather, driver behavior, and historical lane data. 95% accuracy. Continuously recalculated. Built for operations teams who can't afford surprises.",
  ...
  outcomes: {
    label: "What You Get",
    headline: "How TrucksOnTheMap achieves 95% ETA accuracy and spots delays 4 hours early",
    heroCard: {
      icon: Brain,
      target: 95,
      suffix: "%",
      ...
      description: "TrucksOnTheMap processes 50M+ data points per day: traffic, weather, HOS regulations, historical lane patterns, and driver behavior to predict arrivals with 95% accuracy.",
    },
    cards: [
      { icon: Zap, target: 4, suffix: "hrs", sublabel: "earlier detection", title: "Spot delays hours before they happen", description: "Our platform picks up delay signals (weather fronts, traffic buildup, HOS violations) on average 4 hours before impact." },
  ...
  capabilities: {
    ...
    headline: "Predictive ETA features built into TrucksOnTheMap",
    groups: [
  ...
  useCases: {
    label: "Use Cases",
    headline: "Who uses TrucksOnTheMap for predictive ETAs?",
    cases: [
      { id: "warehouse", icon: Factory, label: "Warehouse Operations", image: imgManufacturing, headline: "Predictive ETAs for dock labor planning", description: "Know when trucks will arrive so you can staff docks accordingly. TrucksOnTheMap eliminates overtime from early staffing and detention from late readiness.", benefits: ["Dock labor optimization", "Automated appointment rescheduling", "Arrival sequence prediction", "Shift planning integration"] },
      { id: "3pl", icon: Package, label: "3PL Providers", image: img3pl, headline: "Predictive ETAs as a competitive advantage", description: "Give your clients delivery predictions they can count on. Better ETAs through TrucksOnTheMap mean fewer 'where is my truck?' calls and a premium service.", benefits: ["Client-facing ETA dashboards", "Service level prediction", "Proactive delay notifications", "Carrier performance benchmarking"] },
      ...
      { id: "jit", icon: ArrowDownUp, label: "JIT Manufacturing", image: imgInbound, headline: "Predictive ETAs for just-in-time supply chains", description: "In JIT manufacturing, every minute counts. TrucksOnTheMap gives production planners the visibility to sequence lines and prevent stockouts.", benefits: ["Production line sequencing", "Stockout prevention alerts", "Supplier delivery prediction", "Buffer stock optimization"] },
  ...
  howItWorks: {
    label: "How It Works",
    headline: "How TrucksOnTheMap predicts freight ETAs in five steps",
    steps: [
      { icon: MapPin, step: "01", title: "Collect Live Data", description: "GPS, telematics, traffic feeds, weather APIs, and HOS data stream into TrucksOnTheMap in real time from every active shipment." },
      { icon: Brain, step: "02", title: "Analyze & Predict", description: "Our machine learning models process 50M+ data points daily, combining live conditions with historical lane patterns to generate ETAs." },
      ...
      { icon: Bell, step: "04", title: "Proactive Delay Alerts", description: "When a likely delay is detected, TrucksOnTheMap alerts dispatchers, dock managers, and customers on average 4 hours before impact." },
      { icon: BarChart3, step: "05", title: "Learn & Improve", description: "Every delivered shipment feeds back into the model. Accuracy improves continuously as our system learns your specific lanes and carriers." },
    ],
  },
  compare: {
    label: "TrucksOnTheMap vs. GPS ETAs",
    headline: (
      <>
        TrucksOnTheMap predictive ETAs vs.<br className="hidden sm:block" /> basic GPS distance calculations
      </>
    ),
    features: [
  ...
  faq: {
    ...
    headline: "TrucksOnTheMap predictive ETA FAQ",
    items: [
      { q: "What is predictive ETA software and how is it different from GPS tracking?", a: "Predictive ETA software uses machine learning to analyze traffic patterns, weather forecasts, driver behavior, hours-of-service regulations, and historical lane data. TrucksOnTheMap achieves 95% accuracy versus 60–70% for GPS-only distance/speed calculations." },
      { q: "How accurate is TrucksOnTheMap?", a: "TrucksOnTheMap achieves 95% accuracy within a 30-minute window for deliveries predicted 4+ hours out. Accuracy reaches 98%+ within the final 2 hours as the shipment gets closer." },
      { q: "How does TrucksOnTheMap detect delays before they happen?", a: "Our platform continuously analyzes traffic feeds, weather forecasts, and driver HOS data along the route. When conditions change (a storm, congestion, or mandatory rest stop), the ETA is recalculated and your team is alerted on average 4 hours before impact." },
      { q: "Does TrucksOnTheMap work with any carrier?", a: "Yes. Any carrier with GPS, telematics, or ELD data can be tracked. Mobile app-based tracking is also available for carriers without installed devices." },
      { q: "Does TrucksOnTheMap integrate with dock scheduling?", a: "Yes. When an ETA shifts significantly, our software can automatically update dock appointments, notify warehouse teams, and adjust labor schedules without manual intervention." },
      { q: "How does weather affect the calculations?", a: "48-hour weather forecasts along the entire shipment route are integrated. Our model calculates the impact of specific conditions (snow, rain, fog, extreme heat) on transit times for each corridor." },
      ...
      { q: "Can TrucksOnTheMap send delivery notifications to customers?", a: "Yes. Configurable triggers send automated ETA updates to customers via email, SMS, or branded tracking portals, reducing inbound status calls." },
      { q: "Does TrucksOnTheMap improve over time?", a: "Yes. The model retrains daily with new delivery data from your network. Every completed shipment makes future predictions more accurate, especially for your specific lanes, carriers, and seasonal patterns." },
    ],
  },
  ctaFinal: {
    label: "Ready for Better ETAs?",
    headline: "Let's talk about TrucksOnTheMap",
    subtext: "Book a 30-minute demo. We'll show you how our platform predicts freight arrivals with 95% accuracy and spots delays 4 hours before they hit.",
  },
};
