...
const config: ICPPageConfig = {
  ...
  features: {
    ...
    items: [
      { title: "Availability Forecast Map", description: "See a geographic map of where every trusted carrier will have free trucks — not today, but for the next 5 days. Visual, actionable, bookable. You see capacity before you need it.", image: "https://images.unsplash.com/photo-1553413077-190dd305871c?w=800&q=80&auto=format" },
      { title: "SAP / Oracle OTM Interface", description: "Your ERP sends the freight job. TrucksOnTheMap allocates it to the best available carrier and confirms back. No double entry. No manual handoff. The execution layer SAP was always missing.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format" },
      { title: "MassUpload", description: "Upload 50 freight jobs in a single file. The platform allocates them across your carrier network based on availability, route, and contracted rates — automatically. What took a morning takes 4 minutes.", image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80&auto=format" },
      { title: "99.9% Capacity Security", description: "Your contracted carriers see your upcoming freight demand in advance. They pre-commit capacity to your jobs before you need to ask. Your freight cost per tonne drops. Your on-time delivery rate goes up.", image: "https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80&auto=format" },
      { title: "Real-Time Tracking with ETA per Drop", description: "Actual live position, actual ETA at each delivery point — visible to your transport planning team and to your customer service. Answer delivery questions in 10 seconds, not 10 minutes.", image: "https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=800&q=80&auto=format" },
      { title: "PriceIndex — 90-Day Rate Intelligence", description: "The average, low, and spot market rate for every corridor you operate over the past 90 days. You negotiate carrier contracts from data, not instinct. You know immediately when you're overpaying.", image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80&auto=format" },
    ],
  },
  stats: {
