...
const config: ICPPageConfig = {
  ...
  features: {
    ...
    items: [
      { title: "Availability Forecast Map", description: "See a geographic map of where every trusted carrier will have free trucks — not today, but for the next 5 days. Visual, actionable, bookable. You see capacity before you need it." },
      { title: "SAP / Oracle OTM Interface", description: "Your ERP sends the freight job. TrucksOnTheMap allocates it to the best available carrier and confirms back. No double entry. No manual handoff. The execution layer SAP was always missing." },
      { title: "MassUpload", description: "Upload 50 freight jobs in a single file. The platform allocates them across your carrier network based on availability, route, and contracted rates — automatically. What took a morning takes 4 minutes." },
      { title: "99.9% Capacity Security", description: "Your contracted carriers see your upcoming freight demand in advance. They pre-commit capacity to your jobs before you need to ask. Your freight cost per tonne drops. Your on-time delivery rate goes up." },
      { title: "Real-Time Tracking with ETA per Drop", description: "Actual live position, actual ETA at each delivery point — visible to your transport planning team and to your customer service. Answer delivery questions in 10 seconds, not 10 minutes." },
      { title: "PriceIndex — 90-Day Rate Intelligence", description: "The average, low, and spot market rate for every corridor you operate over the past 90 days. You negotiate carrier contracts from data, not instinct. You know immediately when you're overpaying." },
    ],
  },
  stats: {
