...
const config: ICPPageConfig = {
  ...
  hero: {
    ...
    subtext: "TrucksOnTheMap gives 3PL operations teams a live map of subcarrier capacity across active corridors - seven days forward - so dispatchers allocate jobs to confirmed trucks and SLAs hold without spot market exposure.",
  ...
  narrative: {
    ...
    paragraphs: [
      ...
      "TrucksOnTheMap replaces tribal knowledge with structured data. Every subcarrier publishes available capacity to a shared map. The dispatcher sees the entire network - seven days forward - without making a single call.",
    ],
    image: imgDispatch,
  },
  comparison: {
  ...
  stats: {
    ...
    items: [
      ...
      { value: "−31%", description: "3x faster shipment planning—safely, with only your trusted carriers." },
