...
const config: ProductPageConfig = {
  ...
  hero: {
    ...
    subtext: "TrucksOnTheMap matches loads with qualified carriers in seconds, not hours. Fill trucks faster, cut empty miles, and reduce freight costs by up to 35%.",
  ...
  outcomes: {
    label: "What You Get",
    headline: "How TrucksOnTheMap reduces empty miles and fills trucks faster",
    heroCard: {
      icon: Truck,
      target: 40,
      suffix: "%",
      ...
      description: "Our platform analyzes carrier location, capacity, lane preferences, and past performance to find the best match and eliminate wasted miles.",
    },
    cards: [
      { icon: Zap, target: 15, suffix: "s", sublabel: "match time", title: "Load-to-carrier match in seconds", description: "What used to take hours now takes seconds. TrucksOnTheMap evaluates thousands of options simultaneously." },
      ...
      { icon: Globe, target: 24, suffix: "/7", sublabel: "availability", title: "Digital freight marketplace", description: "Carriers browse, bid, and accept loads around the clock through our platform." },
  ...
  capabilities: {
    ...
    headline: "Load matching features built into TrucksOnTheMap",
    groups: [
  ...
  useCases: {
    label: "Use Cases",
    headline: "Who uses TrucksOnTheMap for load matching?",
    cases: [
      { id: "broker", icon: Package, label: "Freight Brokers", image: img3pl, headline: "Load matching for freight brokerages at scale", description: "Stop spending hours on the phone. TrucksOnTheMap matches thousands of daily loads with your carrier network automatically so you can focus on growing your business.", benefits: ["Instant carrier matching from your network", "Live rate benchmarking per lane", "Automated tender workflows", "Carrier performance tracking"] },
  ...
  howItWorks: {
    label: "How It Works",
    headline: "How TrucksOnTheMap matches loads in five simple steps",
    steps: [
      { icon: Search, step: "01", title: "Post Your Load", description: "Enter load details (origin, destination, commodity, weight, pickup date) or import them from your TMS into TrucksOnTheMap." },
      { icon: Brain, step: "02", title: "Our Platform Finds the Best Match", description: "Every available carrier is scored on lane history, capacity, price, and performance. Results in under 15 seconds." },
  ...
  compare: {
    ...
    headline: (
      <>
        TrucksOnTheMap load matching vs.<br className="hidden sm:block" /> traditional load boards and phone calls
      </>
    ),
    features: [
  ...
  faq: {
    ...
    headline: "TrucksOnTheMap load matching FAQ",
    items: [
      { q: "What is load matching software and how does it work?", a: "Load matching software automatically pairs available freight loads with qualified carriers based on location, capacity, lane history, price, and performance. TrucksOnTheMap replaces manual phone calls and load board searches with fast, accurate matches that cut empty miles and freight costs." },
      { q: "How fast can TrucksOnTheMap find a carrier?", a: "TrucksOnTheMap finds the optimal carrier match in under 15 seconds. Our platform evaluates thousands of options simultaneously, looking at lane history, live availability, pricing, and performance scores." },
      { q: "What is the difference between TrucksOnTheMap and a load board?", a: "Load boards are passive: you post a load and wait. TrucksOnTheMap is active: our software identifies the best carrier for each load based on multi-factor scoring. The result is faster matches, better rates, and fewer empty miles." },
      { q: "How does TrucksOnTheMap reduce empty miles?", a: "By analyzing carrier positions, available capacity, and upcoming loads, our platform identifies backhaul and triangulation opportunities that would be impossible to spot manually. This typically cuts empty miles by 30–40%." },
      { q: "Can TrucksOnTheMap integrate with my TMS?", a: "Yes. TrucksOnTheMap connects to major TMS platforms including SAP TM, Oracle OTM, Blue Yonder, Descartes, and MercuryGate via REST API or EDI. Load data flows automatically between systems." },
      { q: "Does TrucksOnTheMap support LTL and intermodal freight?", a: "Yes. Our platform supports full truckload (FTL), less-than-truckload (LTL), intermodal, and specialized equipment types. Matching rules can be configured by mode, equipment, and commodity." },
      { q: "How much does TrucksOnTheMap cost?", a: "Pricing depends on your volume, number of users, and integration requirements. Most customers see ROI within the first month through reduced empty miles and lower spot rates. Contact us for a quote based on your freight volume." },
      { q: "Is TrucksOnTheMap suitable for small freight brokers?", a: "Yes. Our platform scales from small brokerages handling 50 loads/day to enterprise shippers with thousands of daily shipments. Smaller operations often see the biggest gains because they're replacing the most manual work." },
      { q: "How do carriers join TrucksOnTheMap?", a: "Carriers self-register through our carrier portal. Onboarding includes document verification, insurance compliance checks, and authority validation. Most carriers are live within 24 hours. No software installation required." },
      { q: "What ROI can I expect from TrucksOnTheMap?", a: "Customers typically see 30–40% fewer empty miles, 35% lower freight costs, and 95%+ fill rates. The average payback period is under 3 months." },
    ],
  },
  ctaFinal: {
    label: "Ready to Match Smarter?",
    headline: "Let's talk about TrucksOnTheMap",
    subtext: "Book a 30-minute demo. We'll show you how our platform matches loads in seconds, cuts empty miles, and builds a more reliable carrier network.",
  },
};
