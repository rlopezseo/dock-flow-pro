...
const config: ProductPageConfig = {
  ...
  hero: {
    ...
    subtext: "TrucksOnTheMap digitizes your entire freight procurement cycle, from RFP creation to carrier award. Benchmark rates, compare bids, and source the right carriers in days instead of weeks.",
  ...
  outcomes: {
    label: "What You Get",
    headline: "How TrucksOnTheMap cuts procurement costs by 25% and speeds up RFPs 5x",
    heroCard: {
      icon: TrendingDown,
      target: 25,
      suffix: "%",
      ...
      description: "With TrucksOnTheMap, you invite more carriers, benchmark against market rates, and automate evaluation. Customers consistently save 20–30% compared to manual procurement.",
    },
    cards: [
      { icon: Clock, target: 5, suffix: "x", sublabel: "faster", title: "Accelerate RFP cycle time", description: "From 6 weeks to 6 days. Our digital RFPs with automated evaluation cut procurement timelines dramatically." },
      { icon: Users, target: 300, suffix: "+", sublabel: "carriers per RFP", title: "Evaluate more carriers, less work", description: "Digital distribution through TrucksOnTheMap lets you reach hundreds of carriers at once without adding headcount." },
  ...
  capabilities: {
    ...
    headline: "Procurement features built into TrucksOnTheMap",
    groups: [
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { icon: Users, step: "02", title: "Invite & Distribute", description: "Send the RFP to hundreds of carriers at once. They bid through the TrucksOnTheMap portal. No email chains or spreadsheet attachments." },
  ...
  compare: {
    label: "TrucksOnTheMap vs. Excel Tenders",
    headline: (
      <>
        TrucksOnTheMap procurement vs.<br className="hidden sm:block" /> spreadsheet-based carrier sourcing
      </>
    ),
    features: [
  ...
  faq: {
    ...
    headline: "TrucksOnTheMap freight procurement FAQ",
    items: [
      { q: "What is freight procurement software?", a: "Freight procurement software is a digital platform that replaces manual, spreadsheet-based tendering with automated RFP creation, carrier bidding, rate benchmarking, and award management. TrucksOnTheMap brings everything into one place, with full audit trail." },
      { q: "How much can TrucksOnTheMap save on freight costs?", a: "Customers typically save 20–30% on freight through increased carrier competition, live rate benchmarking, and better award decisions. The biggest savings come from evaluating 10x more carriers per lane than manual processes allow." },
      { q: "How long does a freight RFP take with TrucksOnTheMap?", a: "What used to take 4–8 weeks can be done in 5–7 days. Automated distribution, online bidding, and scoring eliminate the bottlenecks of manual procurement." },
      { q: "Why choose TrucksOnTheMap for freight procurement?", a: "TrucksOnTheMap combines digital RFP creation, live rate benchmarking, automated carrier evaluation, and TMS integration with enterprise-grade security and multi-region support. All in one platform." },
      { q: "Can TrucksOnTheMap benchmark carrier rates?", a: "Yes. Bids are scored against live market rate indices for each lane. You see instantly whether a carrier's bid is above, at, or below market." },
      { q: "Does TrucksOnTheMap integrate with SAP, Oracle, and other ERPs?", a: "Yes. Awarded rate cards can be exported directly to SAP, Oracle, JDE, Blue Yonder, and other TMS/ERP systems via API or EDI. Lane data can also be imported for RFP creation." },
      { q: "How do carriers participate in TrucksOnTheMap procurement?", a: "Carriers receive an invitation link and bid through our secure portal. No software installation needed. They can view lane details, submit rates, and track bid status 24/7." },
      { q: "Is TrucksOnTheMap suitable for small to mid-size shippers?", a: "Yes. Our platform scales from SMB shippers running 10-lane tenders to enterprise operations with 1,000+ lanes. Smaller shippers often see the highest ROI because they're replacing entirely manual work." },
      { q: "What compliance features does TrucksOnTheMap offer?", a: "Every action (bid submission, evaluation criteria, award decision) is logged with timestamps and user attribution. Reports are exportable for audits and regulatory requirements." },
      { q: "How long does it take to implement TrucksOnTheMap?", a: "Most implementations go live within 2–3 weeks, including platform configuration, TMS/ERP integration, user training, and carrier onboarding. No hardware needed." },
    ],
  },
  ctaFinal: {
    label: "Ready to Modernize?",
    headline: "Let's talk about TrucksOnTheMap",
    subtext: "Book a 30-minute discovery call. We'll show you how our platform cuts procurement cycles from weeks to days and saves 25% on freight spend.",
  },
};
