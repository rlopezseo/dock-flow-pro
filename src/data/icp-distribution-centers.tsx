...
const config: ICPPageConfig = {
  ...
  features: {
    ...
    items: [
      { title: "Interactive Dock Scheduling Board", description: "Drag-and-drop visual plan of every dock slot — inbound and outbound, all shifts, all gates simultaneously. Works on tablet, phone, or desktop. The shift supervisor has the same real-time view as the logistics director." },
      { title: "Carrier Self-Booking — TrucksSlot", description: "Carriers log into their own time slot booking portal and select available dock windows. They see open slots. They book what fits their route. Your coordinator reviews, confirms exceptions, and focuses on operations — not on taking booking calls." },
      { title: "Live ETA Monitoring", description: "From the moment a truck is assigned to a booking, TrucksSlot tracks its position and estimated arrival time in real time. Delays are visible hours before they arrive at your yard. Your team has time to respond — not just react." },
      { title: "Automated Rescheduling Alerts", description: "When a truck's ETA changes beyond threshold, the system flags affected dock slots automatically. You get an alert with the option to reschedule, notify the next driver, or redistribute dock staff." },
      { title: "SAP / Oracle / WMS Integration", description: "TrucksSlot works standalone or as the real-time execution layer on top of your existing WMS or ERP. One integration connects your inbound purchase orders to live truck arrivals." },
      { title: "Full Digital Dock Audit Trail", description: "Every truck arrival, loading start, loading completion, and departure — timestamped, logged automatically, exportable in one click. Carrier performance reviews take minutes. Compliance audits have a defensible record." },
    ],
  },
  stats: {
