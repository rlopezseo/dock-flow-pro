...
const config: ICPPageConfig = {
  ...
  features: {
    ...
    items: [
      { title: "Carrier Availability Map", description: "Your trusted carrier network's available trucks — on a live map, updated in real time. No more WhatsApp chains at 7am. You see which carriers have capacity before you need to ask.", image: "https://images.unsplash.com/photo-1553413077-190dd305871c?w=800&q=80&auto=format" },
      { title: "Auto-Match and Bidding Engine", description: "A freight job arrives from the shipper. The platform identifies best-fit carriers based on route, truck type, and live availability. Carriers respond. You confirm. This replaces the WhatsApp group.", image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800&q=80&auto=format" },
      { title: "PriceIndex — 90-Day Rate Intelligence", description: "Know the average, low, and spot market rate for every lane you operate. Stop negotiating carrier rates from memory. Start winning margin because you know the number before you pick up the phone.", image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80&auto=format" },
      { title: "Real-Time Shipment Visibility & Notifications", description: "Shippers get automatic status updates at every milestone. Your team doesn't touch routine updates. Customer service calls drop. You look like a platform company, not a phone-and-email operation.", image: "https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=800&q=80&auto=format" },
      { title: "Subcontractor Tracking API", description: "When you use subcontractors to cover volume peaks, freight visibility doesn't end. The API extends real-time tracking to your full subcontractor network. You remain accountable — now you can actually see what's happening.", image: "https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80&auto=format" },
      { title: "Your Private Carrier Network", description: "Invite-only. Your carrier relationships stay yours. This is not a freight marketplace where you compete with anonymous brokers on price. It's your existing operation, made visible and fast.", image: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&q=80&auto=format" },
    ],
  },
  stats: {
  ...
  sectionImages: {
    ...
    comparison: "https://images.unsplash.com/photo-1573164713988-8665fc963095?w=1920&q=80&auto=format",
