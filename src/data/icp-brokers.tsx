...
const config: ICPPageConfig = {
  ...
  comparison: {
    ...
    items: [
      { label: "Job Throughput", without: "Planners process 7 international freight jobs per day through phone, email, and WhatsApp. 80% of their time is admin, not selling.", withTotm: "The same planner handles 12+ jobs per day with auto-matching, auto-confirmation, and automated freight allocation. Speed is your moat.", image: imgJobThroughput },
      { label: "Shipment Visibility", without: "You have no visibility once the truck leaves. Shippers call for updates and your team loses 2 hours a day answering.", withTotm: "Real-time tracking on every job with automated status notifications. Your team touches exceptions, not every update.", image: imgShipmentVisibility },
      { label: "Rate Intelligence", without: "You negotiate carrier rates from memory and habit. You don't know if you're overpaying until the margin report arrives.", withTotm: "90-day PriceIndex shows average, low, and spot market rates per lane. You negotiate from data, not gut feel.", image: imgRateIntelligence },
    ],
  },
  features: {
    ...
    items: [
      ...
      { title: "AI-Powered RFQ Processing & Bidding", description: "Our AI leverages large language models to understand incoming email RFQs, record them as transport tasks, and autonomously run a BID process with your subcontracted carriers. It selects the optimal offer and submits proposals to clients with your predefined margin — via the same channel the request arrived. More shipments per planner, more RFQs realized.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format" },
